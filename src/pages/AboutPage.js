...
function AboutPage(props) {
    ...
    return (
        < div >
            ...
            <section className="bg-img1 txt-center p-lr-15 p-tb-92 m-t-80" style={{ backgroundImage: 'url(/images/xbg-01.jpg)' }}>
                        ...
                        <div className="col-md-7 col-lg-8">
                            <div className="p-t-7 p-r-85 p-r-15-lg p-r-0-md">
                                ...
                                <p className="stext-113 cl6 p-b-26">
                                    ...
                                    Pellentesque congue ac orci ut gravida. Aliquam erat volutpat. Donec iaculis lectus a
                                    ...
                                    efficitur, quam velit convallis ipsum, et maximus enim ligula ac ligula.
                                </p>
                                <p className="stext-113 cl6 p-b-26">
                        ...
                        <div className="col-11 col-md-5 col-lg-4 m-lr-auto">
                            <div className="how-bor1 ">
                                <div className="hov-img0">
                                    <img src="/images/xabout-01.jpg" alt="IMG" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                        <div className="order-md-2 col-md-7 col-lg-8 p-b-30">
                            <div className="p-t-7 p-l-85 p-l-15-lg p-l-0-md">
                                ...
                                <p className="stext-113 cl6 p-b-26">
                                    ...
                                    malesuada fames ac turpis egestas. Nullam maximus mauris sit amet odio convallis, in
                                    pharetra magna gravida. Praesent sed nunc fermentum mi molestie tempor. Morbi vitae
                                    viverra odio. Pellentesque ac velit egestas, luctus arcu non, laoreet mauris. Sed in
                                    ipsum tempor, consequat odio in, porttitor ante. Ut mauris ligula, volutpat in sodales
                                    in, porta non odio. Pellentesque tempor urna vitae mi vestibulum, nec venenatis nulla
                                    lobortis. Proin at gravida ante. Mauris auctor purus at lacus maximus euismod.
                        ...
                        <div className="order-md-1 col-11 col-md-5 col-lg-4 m-lr-auto p-b-30">
                            <div className="how-bor2">
                                <div className="hov-img0">
                                    <img src="/images/xabout-02.jpg" alt="IMG" />
                                </div>
                            </div>
                        </div>
                    </div>
